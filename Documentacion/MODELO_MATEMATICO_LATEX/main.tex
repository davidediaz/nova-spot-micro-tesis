...
cuando las predicciones se comparen con datos independientes. Permanecen
pendientes las gráficas de workspace/singularidad, implementación verificada de
$\dot{\mat J}$, identificación física y validación experimental.
