...
|---|---|---|---|---|---|---|
| OE1. Caracterizar la plataforma y desarrollar los modelos cinemático y dinámico | Se implementaron cinemática, dinámica y modelos URDF/MJCF; se verificaron en pruebas y simuladores | `Documentacion/MODELO_MATEMATICO_LATEX`, paquetes ROS 2 y pruebas automatizadas | Existe un modelo nominal computable y reproducible; la identificación física sigue incompleta | Geometría, masas, límites y diferencias físicas medidos y contrastados | Caracterización y modelado | Parcial |
