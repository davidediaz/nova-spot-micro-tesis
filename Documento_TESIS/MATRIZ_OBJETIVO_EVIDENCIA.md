...
| OE3. Implementar locomoción convencional para postura, paso y gateo | Se diseñaron trayectorias cartesianas, IK, máquina de estados, fase y líneas base repetidas en Gazebo/MuJoCo | `Documentacion/MARCHA_PASO_VALIDACION.md`, bolsas, CSV e informes | Postura, paso y gateo nominales son repetibles en simulación; la precarga 2,0 produjo vuelo trasero sostenido en dos ensayos | Marchas nominales verificadas también en hardware bajo protocolo | Marcha nominal | Parcial avanzado |
