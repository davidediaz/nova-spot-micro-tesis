...
PPO residual & Cinco semillas y barrido de escala; ninguna escala positiva cumplió el criterio conjunto. & Resultado negativo; transferencia bloqueada. \\
Modelo & 52.111 configuraciones exploradas; postura nominal con $\sigma_{\min}=0{,}038037$ m/rad. & Modelo nominal aún no identificado físicamente. \\
\bottomrule
\end{tabular}
\end{table}
