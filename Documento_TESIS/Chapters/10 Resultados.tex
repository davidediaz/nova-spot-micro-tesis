...
acción respetó en todo momento la envolvente de $±0{,}08$~rad y el cambio
...
La campaña emparejada posterior ejecutó cinco ensayos nominales y cinco con la
capa PPO en Gazebo, con tres ciclos completos por ensayo. En esta primera
conexión se utilizó la política de la semilla 11 para aislar el efecto de la
integración. El PPO redujo el avance medio en 41,355~\% y aumentó el pitch
máximo en 23,893~\%; por tanto, no se selecciona como política mejorada. Este
...
transitorio y se comparó contra los cinco ensayos nominales de referencia. La
política reentrenada incorporó contactos, IMU y altura corporal, pero no mejoró
la locomoción: el avance medio disminuyó 97{,}~\% y la velocidad 98{,}~\%,
mientras que roll y pitch máximos aumentaron 152~\% y 37~\%. Aunque el salto
articular se redujo 67~\%, el criterio conjunto de avance y estabilidad no se
...
condición. Ninguna escala superó la línea base nominal; la escala cero fue la
menos degradante ($0{,}021878$~m/ciclo), mientras que la escala uno alcanzó
...
(semilla 71), aún por debajo de $0{,}027761$~m/ciclo nominal. La auditoría de
...
\caption{Revalidación dinámica: cinco ensayos nominales frente a cinco con la
política PPO reentrenada.}
...
\caption{Comparación emparejada de cinco ensayos nominales y cinco ensayos con
PPO residual en Gazebo.}
...
Se añadió al modelo MuJoCo un acelerómetro en la base y sensores táctiles en
las cuatro esferas de los pies. Estos sensores son equivalentes conceptuales a
la IMU y a los contactos publicados por Gazebo. La bolsa histórica de MuJoCo
fue registrada antes de esta ampliación y por ello no contiene todavía esos
tópicos; no se imputaron contactos ni señales IMU inexistentes. La comparación
de las variables comunes sí mostró una duración media de $5{,}760011$~s en
Gazebo y $5{,}760003$~s en MuJoCo, con diferencia relativa de $-0{,}0001$~%.

\begin{figure}[p]
\centering
\includegraphics[width=0.95\textwidth]{Resultados/comparacion_gazebo_mujoco.png}
\caption{Comparación ciclo a ciclo de las magnitudes registradas en Gazebo y
MuJoCo para la marcha paso. La equivalencia de contactos e IMU queda pendiente
de una nueva bolsa MuJoCo con los sensores expuestos en ROS~2.}
...
También se ejecutó una prueba provocada de seguridad integrada. Una referencia
\texttt{JointTrajectory} con una articulación inexistente fue rechazada por el
controlador y detectada por el supervisor, que registró
\texttt{nombres\_articulares\_invalidos,articulacion\_desconocida} y ordenó la transición
a \texttt{stand}. La evidencia se conserva en
\texttt{Experimentos/prueba\_supervisor\_referencia\_invalida\_20260901}. Este resultado
demuestra la parada preventiva por referencia inválida; las paradas de datos
vencidos, contacto y margen siguen pendientes.
