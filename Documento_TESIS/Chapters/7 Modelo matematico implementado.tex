...
de los límites articulares de una pata. El color representa el menor valor
singular del jacobiano; las configuraciones próximas a cero son las más
cercanas a una pérdida de manipulabilidad.

\begin{figure}[p]
\centering
\includegraphics[width=0.98\textwidth]{Resultados/workspace_singularidades.png}
\caption{Workspace cinemático y distribución del número de condición del
Jacobiano para una pata izquierda. Fuente: elaboración propia.}
...
finitas entre muestras consecutivas. La Figura~\ref{fig:velocidades-articulares}
indica que la velocidad máxima permanece por debajo del límite provisional del
URDF (6,981~rad/s); es una verificación de referencias en simulación, no una
caracterización del servo bajo carga.

\begin{figure}[p]
\centering
\includegraphics[width=0.95\textwidth]{Resultados/velocidades_articulares.png}
\caption{Velocidad articular máxima y media de las referencias nominales de
gateo y paso. La línea discontinua indica el límite de velocidad del URDF.}
