...
text width=3.0cm,minimum height=1.1cm,align=center},
...
\draw[arrow] (cmd) -- (gait);
\draw[arrow] (gait) -- node[above]{referencias} (sim);
...
El supervisor ordenó postura segura cuando se provocaron condiciones de altura
o inclinación insegura y rechazó trayectorias no finitas o fuera de límites.
Las entradas de contacto, vencimiento de datos y margen se mantuvieron
informativas hasta completar pruebas provocadas y definir un rearme seguro.
