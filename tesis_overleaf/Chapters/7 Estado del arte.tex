...
El trabajo parte de la caracterización del Nova Spot Micro y de un controlador discreto existente. Sobre esta base se desarrollarán los modelos, la instrumentación y el protocolo experimental. La política de aprendizaje por refuerzo se evaluará como corrección de referencias nominales, manteniendo límites de acción y un supervisor independiente de seguridad.
